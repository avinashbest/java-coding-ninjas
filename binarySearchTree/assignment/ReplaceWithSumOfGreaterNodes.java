...
public class ReplaceWithSumOfGreaterNodes {
    ...
    public static int replaceWithSumOfGreaterNodes(TreeNode<Integer> root, int sum) {
    ...
    public static int replaceWithSumOfGreaterNodes(TreeNode<Integer> root) {
        return replaceWithSumOfGreaterNodes(root, 0);
    }

    public static void main(String[] args) {
        var root = levelWiseInput();
        System.out.println(replaceWithSumOfGreaterNodes(root));
    }
}
