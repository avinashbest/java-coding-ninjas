...
public class CreateAndDuplicateNode {
    ...
    public static void insertDuplicateNode(BinaryTreeNode<Integer> root) {
        if (root == null) return;
        var newNode = new BinaryTreeNode<Integer>(root.data);
//        Storing the left child of root node temporary
        var rootLeft = root.left;
//        Making the root's left pointer to point the newNode (or duplicate node)
        root.left = newNode;
//        Now, the duplicate node pointing to the root's left child which was stored in temporary variable
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------Modified Tree is-----------");
        printBinaryTree(root);
    }
}
